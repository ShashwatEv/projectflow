                ...
                >
                    ...
                    <div className="flex items-start justify-between mb-4">
                        {user.avatar ? (
                            ...
                            <div className="w-16 h-16 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center text-xl font-bold text-indigo-600 dark:text-indigo-400 border-2 border-white dark:border-gray-700 shadow-sm">
                                {user.name.charAt(0)}
                            </div>
                        )}
                        <button 
